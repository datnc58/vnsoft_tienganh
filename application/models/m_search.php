...
class M_search extends MY_Model
{
    ...
    public function getPoduct_search($where,$limit,$offset){
        $this->db->select('product.id ,product.alias,product.code,product.view,product.multi_image,product.description,product.time,
        product.pro_dir,img_dir,product.name,product.category_id as cat_id,product.image,
        ');
