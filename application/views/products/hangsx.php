                    ...
                    <div class="row_10 row_xs_5">
                        ...
                        <section class="qts_left_content">
                            ...
                            <div class="box_left_cate sc_search_left_cate clearfix">
                                ...
                                <div class="search_size_left search_has_drop hidden">
                                ...
                                <input type="hidden" id="cat_id" value="<?= @$id_cat?>">
                                <div class="clearfix"></div>
                        ...
                        <div class="qts_mid_content">
                            ...
                            <div id="ctl00_pageBody_plhCatalog">
                                ...
                                <div class="list_prod_page_page">
                                    <div class="row_5">
                                        <?php $i=0; foreach ($lists as $pro): $i++;?>
                                            <div class="col-md-3 col-sm-4 col-xs-6">
                                                <div class="row_10">
                                                    <div class="box_prod_cate_cate clearfix">
                                                        <a href="<?= base_url($pro->alias.'.html')?>" class="img_prod_hot h_69_cate_cate">
                                                        ...
                                                        <div class="sub_prod_hot">
                                                            ...
                                                            <div class="clearfix"></div>
                                                            <a href="<?= base_url($pro->alias.'.html')?>" class="view_prod_hot">Chi tiết</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
