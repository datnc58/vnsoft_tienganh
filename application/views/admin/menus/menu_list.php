...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/menu/menulist')?>">Danh sách Menus</a></li>
						 ...
						 " id="tab0primary">
							...
							<div class="">
								<div class="cf nestable-lists">
									...
									<a class="btn btn-primary btn-sm  btn-xs" href="<?= base_url('vnsadmin/menu/addmenu?p=main') ?>">
						...
						<div class="tab-pane fade  <?=($_SESSION['tab_active']==@$m->type)?'in active':''; ?>" id="tab<?=$stt?>primary">
							...
							<div class="">
								<div class="cf nestable-lists">
									...
									<a class="btn btn-primary btn-sm  btn-xs" href="<?= base_url('vnsadmin/menu/addmenu?p='.@$m->type) ?>">
