...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/comment/questions')?>">Danh sách câu hỏi</a></li>
    ...
    <!-- Page Heading -->
	 <div class="box">
		...
		<div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/comment/delete_multi_question')?>">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?= base_url('vnsadmin/comment/delete_question/'.$v->id)?>"
