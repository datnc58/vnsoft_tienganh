...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/store/Ds_shopping')?>">Trang danh sách shop</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/store/add')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form name="formbk" method="post" action="<?=base_url('vnsadmin/store/deletes')?>">
                       ...
                       <?php if (isset($list)) {
                        ...
                        <tr>	
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('vnsadmin/store/edit/'.$v->id)?>" class="btn btn-xs btn-default">
                                <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= base_url('vnsadmin/store/delete/'.$v->id)?>" class="btn btn-xs btn-danger">
