...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/admin/setup_product')?>">Cấu hình thuộc tính sản phẩm</a></li>
                                    ...
                                    <td class="text-center">
                                       <div class="btn-group">
                                        ...
                                        class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                          <a href="<?= base_url('vnsadmin/admin/xoa_thuoctinh/' . $key) ?>"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                       <div class="btn-group">
                                        ...
                                        class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                          <a href="<?= base_url('vnsadmin/admin/xoa_showbut/' .$v->id) ?>"
                                         onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-xs btn-default" title="Sửa"><i class="glyphicon glyphicon-trash"></i></a> 
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    function getModal_attpro() {
        ...
        $.ajax({
            type: "GET",
            dataType:"html",
            url: base_url() + 'vnsadmin/admin/popupdata_attpro',
            data: "",
    ...
    function getModal_button_show() {
        ...
        $.ajax({
            type: "GET",
            dataType:"html",
            url: base_url() + 'vnsadmin/admin/popupdata_butshow',
            data: "",
            success: function (ketqua) {
                $('body').append(ketqua);
                $("#myModal").modal();
