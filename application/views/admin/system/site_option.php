						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<input name="site_video" type="text" class="form-control input-sm"
									   ...
									   value="<?=$row->site_video==''?'':$row->site_video;?>"
...
<?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <label  class="col-sm-12">Hà Nnội</label>

                            <div class="col-sm-12">

                                <input name="hanoi" type="text" class="form-control input-sm"

                                       value="<?=@$row->hanoi;?>" placeholder="">
                            </div>

                        </div>
                        <div class="form-group">

                            <label  class="col-sm-12">Tỉnh lẻ</label>

                            <div class="col-sm-12">

                                <input name="tinhle" type="text" class="form-control input-sm"

                                       value="<?=@$row->tinhle;?>" placeholder="">
                            </div>
