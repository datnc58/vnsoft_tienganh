...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/video/categories')?>">Danh mục video</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/video/add')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/video/deletes')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="todo-list"><a href="<?= base_url('vnsadmin/video/edit/' . $v->id) ?>" title="Sửa sản phẩm">
                                <?= @$v->name ?>
                                </a>
								<div class="tools">
									<a href="<?=base_url($v->alias.'.html')?>">Xem trước</a>
									<a href="<?= base_url('vnsadmin/video/edit/' . $v->id) ?>">Chỉnh sửa</a>
									<a href="<?= base_url('vnsadmin/video/delete/' . $v->id) ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
								</div>
							</td>
							...
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('vnsadmin/video/edit/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('vnsadmin/video/delete/' . $v->id) ?>" title="Xóa"
