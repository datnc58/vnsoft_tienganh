            ...
            <div class="col-md-9" style="font-size: 12px">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-12">Link website</label>
                            <div class="col-sm-12">
								<input type="text" class="form-control input-sm validate[required]" name="link_website"
                                    value="<?=@$edit->link_website;?>" placeholder="Link website"/>
                            </div>
                        </div>
