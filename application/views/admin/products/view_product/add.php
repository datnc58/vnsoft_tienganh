                     ...
                     <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-12">
                                 <textarea name="content1" class="form-control input-sm" placeholder=""
                                           id="ckeditor_detail" rows="4"><?=@$edit->content;?></textarea>
                             </div>
                         </div>
                     </div>
...
<!--                        --><?php //}  } }?>
                        ...
                        <div class="form-group ">
                           <label class="col-sm-2 form-text">Mã sản phẩm :</label>
                           <div class="col-sm-5">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             <label class="col-sm-2 form-text">Giá gốc :</label>
                             <div class="col-sm-5">
                         ...
                         <div class="form-group">
                             <label class="col-sm-2 form-text">Đánh giá :</label>
                             <div class="col-sm-5">
                                 <input type="text" name="quaranty" id="product_quaranty"
                                        data-v-max="9999999999999" data-v-min="0"
                                        class="auto form-control input-sm"
                         ...
                         <div class="form-group">
                             <label class="col-sm-2 form-text">Thương hiệu :</label>
                             <div class="col-sm-5">
                                 <input type="text" name="caption_1" id="product_caption_1"
                                        data-v-max="9999999999999" data-v-min="0"
                                        class="auto form-control input-sm"
