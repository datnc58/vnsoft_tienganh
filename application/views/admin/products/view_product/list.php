...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/product/categories')?>">Danh mục sản phẩm</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/product/add')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/product/deletes')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="todo-list"><a href="<?= base_url('vnsadmin/product/edit/' . $v->id) ?>" title="Sửa sản phẩm">
                                <?= @$v->name ?>
                                </a>
								<div class="tools">
									<a href="<?=base_url('san-pham/'.$v->alias.'.html')?>" target="_blank" >Xem trước</a>
									<a href="<?= base_url('vnsadmin/product/images/' . $v->id) ?>">Thêm ảnh</a>
								</div>
							</td>
							...
							<td class="text-center">
                              <a href="<?= base_url('vnsadmin/product/edit/' . $v->id) ?>"
								class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
							<a href="<?= base_url('vnsadmin/product/delete/' . $v->id) ?>"
