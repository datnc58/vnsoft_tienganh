...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/tag/listnew')?>">Danh sách thẻ tag tin tức</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
			<div class="col-sm-6" >
				  <a href="<?= base_url('vnsadmin/tag/addtagnew')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/tag/deletesnew')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $stt++; ?></td>
							<td class="todo-list"><a href="<?= base_url('vnsadmin/tag/editnew/' . $v->id) ?>" title="Sửa thẻ tag">
                                <?= @$v->name ?>
                                </a>
							</td>
							<td><?= @$v->alias ?></td>
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('vnsadmin/tag/editnew/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('vnsadmin/tag/deletetagnew/' . $v->id) ?>" title="Xóa"
