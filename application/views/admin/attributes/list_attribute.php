    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="<?= base_url('vnsadmin')?>">Admin</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <a href="<?=base_url('vnsadmin/attribute/add')?>">
                                ...
                                <?php foreach($attris as $attri) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?=site_url('vnsadmin/attribute/edit/'.$attri->id)?>" class="btn btn-xs btn-default" title="S?a"><i class="fa fa-pencil"></i></a>
                                            <a href="<?=site_url('vnsadmin/attribute/delete/'.$attri->id)?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-xs btn-danger" title="Xóa" style="color: #fff"><i class="fa fa-times"></i> </a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
...
<script type="text/javascript">
            ...
            $('.view_color_sale').click(function(){
                ...
                //alert(id);
                $.ajax({
                    url: baseurl+"vnsadmin/attribute/update_attr_view",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
