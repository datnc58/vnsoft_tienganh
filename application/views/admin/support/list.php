...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/support/listSuport')?>">hỗ trợ trực tuyến</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/support/add')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form name="formbk" method="post" action="<?=base_url('vnsadmin/support/deletes')?>">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?= base_url('vnsadmin/support/edit/'.$v->id)?>"><?= @$v->name?></a></td>
                            <td><?=@$v->phone;?></td>
							<td><?= $v->email;?></td>
							<td><?= $v->skype;?></td>
							<td>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('vnsadmin/support/edit/'.$v->id)?>" class="btn btn-xs btn-default">
                                <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= base_url('vnsadmin/support/delete/'.$v->id)?>" class="btn btn-xs btn-danger">
