    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?=base_url('vnsadmin/order/orders')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
        <!-- ./col -->
       <?php if(isset($module_news)){ ?>
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="<?= base_url('vnsadmin/news/newslist')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="<?= base_url('vnsadmin/product/products')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?= base_url('vnsadmin/users/listusers')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?= base_url('vnsadmin/contact/contacts')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?= base_url('vnsadmin/email/emails')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="<?= base_url('vnsadmin/comment/comments')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
    </div>
    <!-- /.row -->
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<a class="btn btn-xs btn-danger"
								   ...
								   href="<?= base_url('vnsadmin/order/delete/' . $v->id) ?>" title="Xóa"
