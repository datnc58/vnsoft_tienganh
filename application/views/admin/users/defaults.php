...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/users/listAll')?>">Danh sách thành viên</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/users/add')?>" class="hidden btn btn-success btn-sm">
    ...
    <div class="container-fluid">
        ...
        <div class="row breadcrumb">
            ...
            <div class="col-lg-6 text-right">
                <a href="<?=base_url()?>vnsadmin/user/add" class="btn btn-success btn-xs">
                    <i class="fa fa-plus"></i> Thêm mới
                </a>
        ...
        <div>
                ...
                <form name="frmUser" method="post" action="<?=base_url('vnsadmin/users/delete')?>">
                    <tr>
                        <td>
                            <!--BEGIN: Content-->
                                    ...
                                    <?php foreach($user as $userArray){ ?>
                                        ...
                                        <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>">
                                            ...
                                            <td class="detail_list">
                                                <a class="menu" href="<?php echo base_url() ?>vnsadmin/users/add/<?php echo $userArray->id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                            ...
                                            <td class="detail_list" style="text-align:center;">
                                                <?php if($userArray->use_status == 1){ ?>
                                                    <img src="<?php echo base_url(); ?>assets/img/admin/active.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('vnsadmin/users/deactive/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                                <?php }else{ ?>
                                                    <img src="<?php echo base_url(); ?>assets/img/admin/deactive.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('vnsadmin/users/active/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                                <?php } ?>
                                            </td>
