        ...
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?= base_url('admin/admin/lang/vi') ?>"><img src="<?= base_url()?>assets/css/front_end/img/vn.png" width="25" alt="Việt Nam"> &nbsp; Việt Nam</a></li>

              <li><a href="<?= base_url('admin/admin/lang/en') ?>"><img src="<?= base_url()?>assets/css/front_end/img/en.png" width="25" alt="English"> &nbsp; Englisth</a></li>
              <li><a href="<?= base_url('admin/admin/lang/ja') ?>"><img src="<?= base_url()?>assets/css/front_end/img/ja.png" width="25" alt="Japanese"> &nbsp; Japanese</a></li>
              <li><a href="<?= base_url('admin/admin/lang/ko') ?>"><img src="<?= base_url()?>assets/css/front_end/img/ko.png" width="25" alt="Hàn quốc"> &nbsp; Korea</a></li>
