...
class Raovat extends MY_Controller
{
    ...
    public function listraovat(){
		if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnsadmin/raovat/listraovat?code='
                . $this->input->get('code')
                . '&name=' . $this->input->get('name')
                . '&cate=' . $this->input->get('cate')
                . '&view=' . $this->input->get('view')
            ...
            $config['base_url'] = base_url('vnsadmin/raovat/listraovat');
    ...
    public function add($id_edit=null)
    {
		...
		if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/raovat/listraovat'));
        }
...
//******* danh muc ********************************************************
    ...
    public function cat_add($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/raovat/categories'));
        }
        $data['cate'] = $this->raovat_model->get_data('raovat_category',array(
            'lang' => $this->language
        ),array('sort'=>'asc'));
