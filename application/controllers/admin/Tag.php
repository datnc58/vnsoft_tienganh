...
//    protected $module_name = "News";
	...
	public function listtagpro()
    {
        if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnsadmin/tag/listpro?tagname='
                . $this->input->get('name')
                . '&lang=' . $this->input->get('lang')
            );
            ...
            $config['base_url'] = base_url('vnsadmin/tag/listpro');
	...
	public function addtagpro($id_edit=null)
        {
            ...
            if (isset($_POST['addnews'])) {
              ...
              //end
                redirect(base_url('vnsadmin/tag/listtagpro'));
            }
...
public function listnew()
    {
        if($this->input->get()){
            ...
            $config['page_query_string']    = TRUE;
            $config['enable_query_strings'] = TRUE;
            $config['base_url']             = base_url('vnsadmin/tag/listnew?tagname='
                . $this->input->get('name')
                . '&lang=' . $this->input->get('lang')
            );
            ...
            $config['base_url'] = base_url('vnsadmin/tag/listnew');
	...
	public function addtagnew($id_edit=null)
        {
            ...
            if (isset($_POST['addnews'])) {
              ...
              //end
                redirect(base_url('vnsadmin/tag/listnew'));
            }
