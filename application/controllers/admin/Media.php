...
//    ======================================================================================================================
...

    {
        ...
        if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnsadmin/media/listAll?name='
            ...
            $config['base_url'] = base_url('vnsadmin/media/listAll');
...

    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/media/listAll'));
...
//******* danh muc ********************************************************
...

    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/media/categories'));
