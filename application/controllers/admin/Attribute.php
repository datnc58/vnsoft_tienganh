    ...
    public function addbrand($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
           ...
           if($id){
            ...
            redirect(base_url('vnsadmin/attribute/listBrand'));
        }
...
//=========== locale ==================================================================================================
    ...
    public function addlocale($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/attribute/listLocale'));
        }
...
public function listColor()
    ...
    public function addcolor($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/attribute/listColor'));
        }
 ...
 public function listprice()
    ...
    public function addprice($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/attribute/listprice'));
        }
...
public function listOption()
    ...
    public function addoption($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/attribute/listOption'));
        }
