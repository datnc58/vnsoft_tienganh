...
public function listWard()
    {
		if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnsadmin/province/listWard?name='
                . $this->input->get('name')
                . '&cate=' . $this->input->get('cate')
            );
			...
			$config['page_query_string']    = TRUE;
			$config['enable_query_strings'] = TRUE;
			$config['base_url']             = base_url('vnsadmin/province/listWard?');
...
public function listDistric()
    {
		if($this->input->get()){
            ...
            $config['page_query_string']    = TRUE;
            $config['enable_query_strings'] = TRUE;
            $config['base_url']             = base_url('vnsadmin/province/listDistric?name='
                . $this->input->get('name')
                . '&cate=' . $this->input->get('cate')
            );
		...
		$config['page_query_string']    = TRUE;
		$config['enable_query_strings'] = TRUE;
		$config['base_url']             = base_url('vnsadmin/province/listDistric?');
