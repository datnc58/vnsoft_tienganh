...
$route['load-view'] = 'products/laod_view';
...
$route['video/([a-zA-Z0-9_-]+)'] = 'video/category/$1/$2';

$route['video/([a-zA-Z0-9_-]+)/(:num)'] = 'video/category/$1/$2/$3';
...
$route['cart/quick_buy'] = 'cart/quick_buy';
